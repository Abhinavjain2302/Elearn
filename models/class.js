...
module.exports.addClass=function(info,callback){
    ...
    description = info['class_description'];
    title = info['class_title'];

    var newClass = new Class({title:title,description:description});
    newClass.save(callback);
   
}


module.exports.addInstructor=function(info,callback){
  instructor_username = info['instructor_username'];
  class_id = info['class_id'];
  console.log("info");
  console.log(info);
  Class.findByIdAndUpdate(class_id,{instructor:instructor_username},callback);
